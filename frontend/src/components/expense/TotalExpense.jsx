...
function TotalExpense() {
  ...
  if (totalExpenseTransactions.length === 0) {
    return (
  ...
  const firstColumnTransactions = totalExpenseTransactions.slice(0, 5);
  const secondColumnTransactions = totalExpenseTransactions.slice(5, 10);
  const isLastBatch = totalExpenseTransactions.length <= 10;
  ...
  return (
    <>
      ...
      <AddEntryModal
        ...
        edit={!!editData}
        id={editData?._id}
        name={editData ? 'Edit Expense' : 'Add Expense'}
      ...
      {isLastBatch && totalExpenseTransactions.length > 0 && (
